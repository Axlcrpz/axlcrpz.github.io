...
export function renderHero() {
  ...
  const cv = profile.resumeUrl
    ? `<a class="btn btn--ghost" href="${esc(profile.resumeUrl)}" target="_blank" rel="noopener">Download CV</a>`
    : "";
  ...
  mount(
    ...
    <div class="hero-grid container">
      ...
      <div class="hero-visual animate-in" style="animation-delay:.15s" aria-hidden="true">
